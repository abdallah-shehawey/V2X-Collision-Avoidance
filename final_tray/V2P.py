...
_CAR_TL_FLAG     = 2          # default RED  (traffic_flag int: 0=GREEN,1=YELLOW,2=RED)
_CAR_TL_STR      = "RED"      # human-readable string for V2I logic
_PED_TL_STR      = "DONT_WALK"

# traffic_flag → human string (V2I logic uses "GREEN"/"YELLOW"/"AMBER"/"RED")
_TL_FLAG_TO_STR = {0: "GREEN", 1: "YELLOW", 2: "RED", 3: "RED"}
_TL_STR_TO_PED  = {"GREEN": "WALK", "YELLOW": "DONT_WALK",
                   "RED": "DONT_WALK", "AMBER": "DONT_WALK"}
...
def _publish_v2p_frame(pedestrian_flag: int, position_flag) -> None:
    """
    ...
    position_flag   : int | None
        0 = LEFT zone, 1 = RIGHT zone, None = other
    """
...
# ============================================================
def get_position_flag(cx: int) -> int | None:
    """
...
def get_position_label(cx: int, x1: int, y1: int,
    ...
    if flag is None:
        return None
    h_label  = "LEFT" if flag == 0 else "RIGHT"
...
try:
    while True:
        ...
        frame_pos_flag  = None   # position flag of highest-risk pedestrian
        ...
        _publish_v2p_frame(frame_ped_flag, frame_pos_flag)
    ...
    _publish_v2p_frame(0, None)          # clear hub state on exit
