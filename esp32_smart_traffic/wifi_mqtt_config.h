/******************************************************************************
 * @file           : wifi_mqtt_config.h
 * @author         : Aya Gamal
 * @brief          : MQTT & Hardware Configurations
 * @description    : Network connection credentials and topic metadata constants
 ******************************************************************************/
...
// 3. MQTT Topics
// ==========================================
// Topic to subscribe for incoming command events
