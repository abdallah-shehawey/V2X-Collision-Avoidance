 ...
 * @example NVIC_vEnableIRQ(NVIC_EXTI0);
 */
 ...
 * @return ErrorState_t Returns OK if successful, NOK if IRQ number is invalid.
 * @example NVIC_vDisableIRQ(NVIC_EXTI0);
 */
 ...
 * @return ErrorState_t Returns OK if successful, NOK if IRQ number is invalid.
 * @example NVIC_vSetPendingFlag(NVIC_EXTI0);
 */
 ...
 * @return ErrorState_t Returns OK if successful, NOK if IRQ number is invalid.
 * @example NVIC_vClearPendingFlag(NVIC_EXTI0);
 */
 ...
 * @example NVIC_vSetPriority(NVIC_EXTI0, 2);
 */
